...
% Last Modified by GUIDE v2.5 2-Apr-2019 12:49:28
...
load hog_features_final_with_prateek
...
%% Process the image and do KNN classification
...
if numel(bbox)== 4
    ...
    [feat] = hog_feature_vector(face);
    
    c=knnclassify(feat,fea,group);
